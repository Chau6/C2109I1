...
namespace Exam_CSharp_09_01_2023
{
    public partial class Show3 : Form
    {
        ...
        private void Show3_Load(object sender, EventArgs e)
        {
            ...
            command.CommandText = "select tblStudent.stuId,tblStudent.stuName,tblExam.examMark from tblStudent left join tblExam on tblStudent.stuId = tblExam.stuId where tblExam.examMark >= 4 order by tblStudent.stuId";
