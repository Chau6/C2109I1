...
namespace Exam_CSharp_09_01_2023
{
    public partial class Show6 : Form
    {
        ...
        private void Show6_Load(object sender, EventArgs e)
        {
            ...
            command.CommandText = "select tblStudent.stuId,tblStudent.stuName,tblExam.examMark from tblStudent left join tblExam on tblStudent.stuId = tblExam.stuId where tblExam.examMark = (select min(tblExam.examMark) from tblExam) order by tblStudent.stuId";
