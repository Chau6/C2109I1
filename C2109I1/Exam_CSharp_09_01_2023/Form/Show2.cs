...
namespace Exam_CSharp_09_01_2023
{
    public partial class Show2 : Form
    {
        ...
        private void Show2_Load(object sender, EventArgs e)
        {
            ...
            command.CommandText = "select tblStudent.stuId,tblStudent.stuName,tblExam.examMark from tblStudent left join tblExam on tblStudent.stuId = tblExam.stuId where tblExam.examMark < 4 or tblExam.examMark is null and tblStudent.stuLevel > 2 order by tblStudent.stuId";
