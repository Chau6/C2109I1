...
namespace Exam_CSharp_09_01_2023
{
    public partial class Show1 : Form
    {
        ...
        private void Show1_Load(object sender, EventArgs e)
        {
            ...
            command.CommandText = "select tblStudent.stuId,tblStudent.stuName,tblExam.examMark from tblStudent left join tblExam on tblStudent.stuId = tblExam.stuId where tblStudent.stuId = tblExam.stuId order by tblStudent.stuId";
